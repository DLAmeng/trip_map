...
export type SortBy = 'updated' | 'name' | 'spots' | 'created';
 ...
 */
export function formatUpdatedAt(trip: TripListItem): string {
 ...
 */
export function formatDurationChip(trip: TripListItem): string {
...
export function formatDestination(trip: TripListItem): string {
