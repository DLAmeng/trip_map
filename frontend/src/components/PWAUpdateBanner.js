...
export function PWAUpdateBanner() {
    ...
    if (!needRefresh)
        return null;
    return (_jsxs("div", { className: "pwa-update-banner", role: "status", "aria-live": "polite", children: [_jsx("span", { className: "pwa-update-banner-icon", "aria-hidden": "true", children: "\uD83D\uDE80" }), _jsx("span", { className: "pwa-update-banner-text", children: "\u6709\u65B0\u7248\u672C\u53EF\u7528" }), _jsxs("div", { className: "pwa-update-banner-actions", children: [_jsx("button", { type: "button", className: "pwa-update-banner-btn pwa-update-banner-btn-primary", onClick: () => updateServiceWorker(true), children: "\u7ACB\u5373\u5237\u65B0" }), _jsx("button", { type: "button", className: "pwa-update-banner-btn pwa-update-banner-btn-ghost", onClick: () => setNeedRefresh(false), children: "\u7A0D\u540E" })] })] }));
}
