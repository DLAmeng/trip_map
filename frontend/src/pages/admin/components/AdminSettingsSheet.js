 ...
 */
export function AdminSettingsSheet({ isOpen, onClose, meta, spots, isDefaultTrip, onUpdateMeta, onAddImportedSpots, onReload, onImport, onExport, isReloading, isSaving, isSyncing, }) {
    // Esc 关闭
    useEffect(() => {
        if (!isOpen)
            return;
